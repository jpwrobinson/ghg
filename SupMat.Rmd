...
**Fig. S`r i`. Carbon footprint of seafood species corrected for edible portions** Points are kg CO2-eq for groups of global seafood products (A) and UK-specific seafood productions (B), showing unprocessed estimates (black) and estimates for processed, edible seafood (red).
