...
**Fig. S`r i`. Seafood exported from the UK in 2019** A) Export volume in tonnes of live weight and B) export volume as a proportion of available seafood (landed + farmed + imported). Seafood products shown had more than 100 tonnes total production (i.e. those in Fig. 2).
