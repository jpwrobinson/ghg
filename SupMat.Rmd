...
**Fig. S`r i`. Carbon emissions per nutrient target for UK seafood products against sustainability score (A) and average price per kg (GBP) (B)** Points are the mean kg CO2-eq per nutrient target for each seafood product by the mean sustainability score across multiple stocks or production methods (MSC REF) and price per kg (Seafish 2021). Error bars in A show the minimum and maximum value for sustainability scores and kg CO2-eq.
