...
rda<-data.frame(nutrient = c('calcium', 'iron', 'selenium', 'zinc', 'vitamin_a', 'omega_3', 'vitamin_d', 'vitamin_b12', 'folate'))
...
rda$rni_women = c(ca, fe, se, zn, vita, omega, vitd, vitb12, folate)
...
rda$rda_kids = c(ca, fe, se, zn, vita, omega, vitd, vitb12, folate)
